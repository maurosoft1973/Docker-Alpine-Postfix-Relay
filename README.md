...
* ```:3.15.3-3.6.6-r0``` 3.15.3-3.6.6-r0 branch based (Automatic Architecture Selection)
* ```:3.15.3-3.6.6-r0-aarch64```   3.15.3 64 bit ARM
* ```:3.15.3-3.6.6-r0-armhf```     3.15.3 32 bit ARM v6
* ```:3.15.3-3.6.6-r0-armv7```     3.15.3 32 bit ARM v7
* ```:3.15.3-3.6.6-r0-ppc64le```   3.15.3 64 bit PowerPC
* ```:3.15.3-3.6.6-r0-x86```       3.15.3 32 bit Intel/AMD
* ```:3.15.3-3.6.6-r0-x86_64```    3.15.3 64 bit Intel/AMD
...
***
###### Last Update 08.05.2022 09:11:15
